...
#Miro las características de ambos conjuntos con el comando "?" en la consola
...
#Que los animales no están bien escritos
...
plot(cabbages$VitC, cabbages$HeadWt, pch=c(1,22))

c39 <- lm(cabbages$VitC ~ cabbages$HeadWt, data = cabbages, subset = which(Cult=="c39"))

c52 <- lm(cabbages$VitC ~ cabbages$HeadWt, data = cabbages, subset = which(Cult=="c52"))
